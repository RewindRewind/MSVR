...
function draw() {
  ...
  let tr = m4.translation(-0.4 * accelerometer.x + 0.8 * accelerometer.x, -0.4 * accelerometer.y + 0.8 * accelerometer.y, -0.4 * accelerometer.z + 0.8 * accelerometer.z);
  gl.uniform3fv(shProgram.iTranslatePoint, [-0.4 * accelerometer.x + 0.8 * accelerometer.x, -0.4 * accelerometer.y + 0.8 * accelerometer.y, -0.4 * accelerometer.z + 0.8 * accelerometer.z])
  gl.uniform1f(shProgram.iScalingKoef, -scalingKoef);
  point.DisplayPoint();
  if (audioPanner) {
    audioPanner.setPosition(-0.4 * accelerometer.x + 0.8 * accelerometer.x, -0.4 * accelerometer.y + 0.8 * accelerometer.y, -0.4 * accelerometer.z + 0.8 * accelerometer.z)
  }
}
